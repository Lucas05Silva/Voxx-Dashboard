...
export const demoData = {
  ...
  operational: {
    customersTable: [
      ...
      { id: 'C-11905', name: 'Juliana Ribeiro', code: 'VX-1003', plan: '300MB', status: 'ativo', city: 'Hortolândia', monthlyValue: 79.9, dueDate: '25/03/2026', actionLabel: 'Ver detalhes' },
      { id: 'C-09147', name: 'Rafael Nunes', code: 'VX-1004', plan: '100MB', status: 'suspenso', city: 'Sumaré', monthlyValue: 69.9, dueDate: '08/03/2026', actionLabel: 'Atualizar status' },
    ...
    ticketList: [
      ...
      { id: 'TK-2143', protocol: '2026-0002143', client: 'Clínica São Rafael', priority: 'media', status: 'em atendimento', owner: 'Lucas M.', sla: '01:22', actionLabel: 'Atualizar status' },
      ...
      { id: 'TK-2145', protocol: '2026-0002145', client: 'Auto Peças Veloz', priority: 'alta', status: 'aberto', owner: 'Equipe Campo 2', sla: '00:55', actionLabel: 'Escalar ticket' },
    ],
    installationList: [
      { id: 'OS-901', client: 'Clínica São Rafael', plan: '700MB', technician: 'André S.', status: 'em andamento', scheduledDate: '17/03/2026', actionLabel: 'Atualizar status' },
      { id: 'OS-902', client: 'Patrícia Gomes', plan: '300MB', technician: 'Equipe 5', status: 'pendente', scheduledDate: '18/03/2026', actionLabel: 'Reagendar instalação' },
      { id: 'OS-903', client: 'Auto Peças Veloz', plan: '1GB', technician: 'Carlos T.', status: 'concluida', scheduledDate: '16/03/2026', actionLabel: 'Ver detalhes' },
      { id: 'OS-904', client: 'Condomínio Vista Azul', plan: '500MB', technician: 'Equipe 3', status: 'reagendada', scheduledDate: '19/03/2026', actionLabel: 'Confirmar agenda' },
    ],
  },
  funnel: {
    steps: funnelData,
